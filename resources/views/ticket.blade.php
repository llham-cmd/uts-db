        ...
        @if($transaction->status === 'pending')
            ...
            <div id="pending-view">
                <div class="text-center mb-8">
                    ...
                    <p class="text-indigo-100 mt-2">Pesanan Anda sudah tercatat. Selesaikan pembayaran untuk menerbitkan tiket.</p>
                </div>

                <div class="bg-white text-slate-900 rounded-[2.5rem] overflow-hidden shadow-2xl p-8 space-y-6">
                    <div class="grid grid-cols-2 gap-6">
                        ...
                        <div>
                            <p class="text-slate-400 text-xs font-bold uppercase mb-1">Event</p>
                            <p class="font-bold text-lg">{{ $transaction->event->title }}</p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p class="font-bold">Rp {{ number_format($transaction->total_price, 0, ',', '.') }}</p>
                        </div>
                    </div>

                    <div class="bg-orange-50 border border-orange-200 text-orange-700 text-sm font-medium p-4 rounded-2xl">
                        Simpan Order ID ini. Tiket akan otomatis terbit setelah pembayaran kami terima.
                    </div>

                    <a href="{{ route('home') }}" class="block text-center mt-4 text-slate-500 font-bold hover:text-indigo-600">Kembali ke Beranda</a>
                </div>
            </div>
